  ...
  >
    ...
    <div class="relative z-10 flex items-center gap-3 pointer-events-none">
      <div class="flex items-center gap-3 mr-4 pl-2">
        ...
        ></div>
        <span class="font-bold text-zinc-100 tracking-[0.2em] text-xs"
          >WHITEMALEO</span
        >
      </div>
      ...
      <div
        class="pointer-events-auto flex items-center gap-2 ml-2 pl-4 border-l border-white/5"
      >
        <button
          aria-label="Minimize"
  ...
  <div class="flex flex-1 gap-4 overflow-hidden">
    ...
    >
      <div class="flex border-b border-white/5 bg-black/20">
        <button
          class="px-6 py-3 text-xs font-bold tracking-wide transition-colors {activeTab ===
          'body'
    ...
    >
      ...
      <div
        class="flex-1 overflow-auto bg-transparent relative custom-scrollbar"
      >
        {#if loading}
          <div
